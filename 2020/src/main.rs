...
use day6::{collate_customs_answers, collate_customs_answers_correctly};
...
fn main() {
    ...
    assert_eq!(6504, collate_customs_answers());
    assert_eq!(3351, collate_customs_answers_correctly());

    println!("{}", collate_customs_answers_correctly())
}
